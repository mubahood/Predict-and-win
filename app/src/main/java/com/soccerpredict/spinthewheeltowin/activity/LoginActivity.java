        ...
        my_call.enqueue(new Callback<List<UserModel>>() {
            ...
            public void onResponse(Call<List<UserModel>> call, Response<List<UserModel>> response) {
                ...
                try {
                    ...
                    loggedInUserModel.first_name = response.body().get(0).first_name + " " + response.body().get(0).last_name;
                    loggedInUserModel.last_name = response.body().get(0).last_name + " " + response.body().get(0).last_name;
